...
import 'package:projetboranzopi/personne.dart';
import 'package:projetboranzopi/update.dart';
import 'package:projetboranzopi/deleteP.dart';
...
void main() {
  ...
  runApp(MaterialApp(
    ...
    routes: {
      '/':(context)=>Personne(),
      '/edit':(context)=>EditPersonne (),
        '/delete':(context)=>DeletePersonne(),
    },
    initialRoute: '/',
  ));
